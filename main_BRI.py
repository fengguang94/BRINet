...
if __name__ == "__main__":
    ...
    parser.add_argument('-m', type = str, default = 'test') # 'train' 'test'
    parser.add_argument('-n', type = str, default = 'BRI')
    parser.add_argument('-i', type = int, default = 650000)
    parser.add_argument('-s', type = int, default = 50000)
    parser.add_argument('-d', type = str, default = 'unc') # 'Gref' 'unc' 'unc+' 'referit'
    parser.add_argument('-v', default = True, action = 'store_true')
    parser.add_argument('-c', default = True, action = 'store_true') # whether or not apply DenseCRF
    parser.add_argument('-w', type = str, default = 'deeplab') # 'resnet' 'deeplab'
    parser.add_argument('-t', type = str, default = 'testA') # 'train' 'trainval' 'val' 'test' 'testA' 'testB'
